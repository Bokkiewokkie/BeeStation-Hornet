...
/mob/living/simple_animal/hostile/swarmer
	...
	var/static/list/cannot_integrate = typecacheof(list(/turf/closed/indestructible))
	var/static/list/too_important = typecacheof(list())
...
/mob/living/simple_animal/hostile/swarmer/proc/DismantleMachine(obj/machinery/target)
	do_attack_animation(target)
	to_chat(src, "<span class='info'>We begin to dismantle [target]. We will need to be uninterrupted.</span>")
